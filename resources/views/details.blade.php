    ...
    <section class="product-single container">
      <div class="row">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  ...
                  @foreach(explode(',',$product->images) as $fimg)
                    <div class="swiper-slide product-single__image-item">
                        <img loading="lazy" class="h-auto" src="{{asset('uploads/products')}}/{{$fimg}}" width="674" height="674" alt="" />
                        <a data-fancybox="gallery" href="{{asset('uploads/products')}}/{{$fimg}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <use href="#icon_zoom" />
                        </svg>
                        </a>
        ...
        <div class="col-lg-5">
          ...
          <form action="{{route('wishlist.item-remove',Cart::instance('wishlist')->content()->where('id',$product->id)->first()->rowId)}}" method="post" id="remove-item">
            @csrf
            @method('delete')
            <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick="document.getElementById('remove-item').submit();" ><svg width="16" height="16" viewBox="0 0 20 20"
          ...
          <div class="swiper-wrapper">
            @foreach($rproducts as $rproduct)
                ...
                <div class="pc__img-wrapper">
                    ...
                    @foreach(explode(',',$rproduct->images) as $fimage)
                    <img loading="lazy" src="{{asset('uploads/products')}}/{{$fimage}}" width="330" height="400" alt="{{$rproduct->name}}" class="pc__img pc__img-second">
                    @endforeach
                    </a>
