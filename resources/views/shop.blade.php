                ...
                <ul class="list list-inline mb-0">
                  ...
                  <li class="list-item">
                   <span class="menu-link py-1">
                    ...
                    @if(in_array($category->id,explode(',',$f_categories))) checked="chcked" @endif />
                    {{$category->name}}
                   </span>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                data-slider-max="15000" data-slider-step="5" data-slider-value="[{{$min_price}},{{$max_price}}]" data-currency="$" />
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0 text-center" aria-label="Page Size" id="pagesize" name="pagesize" style="margin-right:20px;">
            ...
            @foreach($products as $product)
                <div class="product-card-wrapper">
                    ...
                    <div class="pc__img-wrapper">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                            <a href="{{route('shop.product-details',$product->slug)}}"><img loading="lazy" src="{{asset('uploads/products')}}/{{$product->image}}" width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>
                            </div>
                            <div class="swiper-slide">
                                @foreach(explode(',',$product->images) as $fimage)
                                    <a href="{{route('shop.product-details',$product->slug)}}"><img loading="lazy" src="{{asset('uploads/products')}}/{{$fimage}}" width="330" height="400" alt="{{$product->name}}" class="pc__img"></a>   
                                @endforeach
                            </div>
                        </div>
